Contributing to MasterCoreCoin Core
==================================

The MasterCoreCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterCoreCoin Core project, and is not to be
confused with overall MasterCoreCoin Network Protocol consensus changes.

Whether a pull request is merged into MasterCoreCoin Core rests with the project merge
...
Patches that change MasterCoreCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterCoreCoin consensus, it must have been
...
The project leader is the release manager for each MasterCoreCoin Core release.
