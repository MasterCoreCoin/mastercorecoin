...
#   c) node1 mines 32 blocks, so now node 0 has 500000MAC, node 1 has 4250MAC, node2 has none.
#   d) node0 sends 601 MAC to node2, in two transactions (301 MAC, then 300 MAC).
