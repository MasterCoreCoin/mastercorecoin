...
In order to support loading of multiple wallets in mastercorecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mastercorecoin.cpp.
...
Changes to mastercorecoin.cpp
----------------------
mastercorecoin.cpp is the entry point into mastercorecoin-qt, and as such, will require some minor modifications to provide hooks for
