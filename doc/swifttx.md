...
This mechanism has been integrated into Bitcore-Node-MasterCoreCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MasterCoreCoin/insight-api-mastercorecoin#web-socket-api](https://github.com/MasterCoreCoin/insight-api-mastercorecoin#web-socket-api)
* API: [https://github.com/MasterCoreCoin/insight-api-mastercorecoin#swifttx-transactions](https://github.com/MasterCoreCoin/insight-api-mastercorecoin#swifttx-transactions)
...
By default, the MasterCoreCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MasterCoreCoin Core daemon:
