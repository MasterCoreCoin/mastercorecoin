...
Intro
-----
MasterCoreCoin (MAC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MasterCoreCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run mastercorecoin-qt.exe.

MasterCoreCoin Core is the original MasterCoreCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of MasterCoreCoin transactions;
