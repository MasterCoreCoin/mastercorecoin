...
void ThreadFlushWalletDB(const string& strFile)
{
    ...
    RenameThread("mastercorecoin-wallet");
...
bool CWalletDB::Recover(CDBEnv& dbenv, std::string filename, bool fOnlyKeys)
{
    ...
    // Call MasterCoreCoin with fAggressive=true to
    // get as much data as possible.
    // Rewrite mastercorecoind data to wallet.dat
    ...
    std::vector<CDBEnv::KeyValPair> mastercorecoindData;
    bool allOK = dbenv.MasterCoreCoin(newFilename, true, mastercorecoindData);
    if (mastercorecoindData.empty()) {
        LogPrintf("MasterCoreCoin(aggressive) found no records in %s.\n", newFilename);
        return false;
    }
    LogPrintf("MasterCoreCoin(aggressive) found %u records\n", mastercorecoindData.size());
    ...
    BOOST_FOREACH (CDBEnv::KeyValPair& row, mastercorecoindData) {
        if (fOnlyKeys) {
