...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterCoreCoin Core mastercorecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mastercorecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mastercorecoin transaction") + "\n" +
                               "  mastercorecoin-tx [options] -create [commands]   " + _("Create hex-encoded mastercorecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mastercorecoin transaction
