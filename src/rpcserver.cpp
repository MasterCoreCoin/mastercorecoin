...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MasterCoreCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MasterCoreCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasterCoreCoin features */
        {"mastercorecoin", "masternode", &masternode, true, true, false},
        {"mastercorecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mastercorecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mastercorecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mastercorecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mastercorecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mastercorecoin", "startmasternode", &startmasternode, true, true, false},
        {"mastercorecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mastercorecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mastercorecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mastercorecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mastercorecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mastercorecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mastercorecoin", "mnbudget", &mnbudget, true, true, false},
        {"mastercorecoin", "preparebudget", &preparebudget, true, true, false},
        {"mastercorecoin", "submitbudget", &submitbudget, true, true, false},
        {"mastercorecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mastercorecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mastercorecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mastercorecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mastercorecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mastercorecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mastercorecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mastercorecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"mastercorecoin", "mnsync", &mnsync, true, true, false},
        {"mastercorecoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> mastercorecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29872/\n";
}
