...
#if defined(NDEBUG)
#error "MasterCoreCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in umac) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        ...
        return nSubsidy;
         ...
         if (nHeight >=      1 && nHeight <=      1) {nSubsidy = 15000000.00 * COIN;}
    else if (nHeight >=      2 && nHeight <=  21600) {nSubsidy =        0.50 * COIN;}
    else if (nHeight >=  21601 && nHeight <=  43200) {nSubsidy =        1.00 * COIN;}
    else if (nHeight >=  43201 && nHeight <=  64800) {nSubsidy =        1.50 * COIN;}
    else if (nHeight >=  64801 && nHeight <=  86400) {nSubsidy =        2.00 * COIN;}
    else if (nHeight >=  86401 && nHeight <= 109440) {nSubsidy =        2.50 * COIN;}
    else if (nHeight >= 109441 && nHeight <= 131040) {nSubsidy =        3.00 * COIN;}
    else if (nHeight >= 131041 && nHeight <= 152640) {nSubsidy =        3.50 * COIN;}
    else if (nHeight >= 152641 && nHeight <= 174240) {nSubsidy =        4.00 * COIN;}
    else if (nHeight >= 174241 && nHeight <= 197280) {nSubsidy =        4.50 * COIN;}
    else if (nHeight >= 197281 && nHeight <= 218880) {nSubsidy =        5.00 * COIN;}
    else if (nHeight >= 218881 && nHeight <= 240480) {nSubsidy =        5.50 * COIN;}
    else if (nHeight >= 240481 && nHeight <= 262080) {nSubsidy =        6.00 * COIN;}
    else if (nHeight >= 262081 && nHeight <= 285120) {nSubsidy =        6.50 * COIN;}
    else if (nHeight >= 285121 && nHeight <= 306720) {nSubsidy =        7.00 * COIN;}
    else if (nHeight >= 306721 && nHeight <= 328320) {nSubsidy =        7.50 * COIN;}
    else if (nHeight >= 328321 && nHeight <= 349920) {nSubsidy =        8.00 * COIN;}
    else if (nHeight >= 349921 && nHeight <= 372960) {nSubsidy =        8.50 * COIN;}
    else if (nHeight >= 372961 && nHeight <= 394560) {nSubsidy =        9.00 * COIN;}
    else if (nHeight >= 394561 && nHeight <= 416160) {nSubsidy =        9.50 * COIN;}
    else if (nHeight >= 416161 && nHeight <= 437760) {nSubsidy =       10.00 * COIN;}
    else if (nHeight >= 437761 && nHeight <= 460800) {nSubsidy =       10.50 * COIN;}
    else if (nHeight >= 460801 && nHeight <= 482400) {nSubsidy =       11.00 * COIN;}
    else if (nHeight >= 482401 && nHeight <= 504000) {nSubsidy =       11.50 * COIN;}
    else if (nHeight >= 504001 && nHeight <= 525600) {nSubsidy =       12.00 * COIN;}
    else if (nHeight >= 525601                     ) {nSubsidy =        5.00 * COIN;}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        ...
        return nSubsidy;
            ...
            if (nHeight >=         1 && nHeight <=     100) {nSubsidy = 0;}
       else if (nHeight >=       101 && nHeight <=    86400) {nSubsidy = blockValue * 0.80;}
       else if (nHeight >=     86401 && nHeight <=   174240) {nSubsidy = blockValue * 0.85;}
       else if (nHeight >=    174241                       ) {nSubsidy = blockValue * 0.90;}
...
{
    RenameThread("mastercorecoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // MAC: We use certain sporks during IBD, so check to see if they are
