                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasterCoreCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MAC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mastercorecoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasterCoreCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MasterCoreCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterCoreCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MAC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MAC addresses"));
    ...
    openAction->setStatusTip(tr("Open a mastercorecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasterCoreCoin Core help message to get a list with possible MasterCoreCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasterCoreCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasterCoreCoin network", "", count));
}
...
{
    QString strTitle = tr("MasterCoreCoin Core"); // default title
    ...
    // Append title to "MasterCoreCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
