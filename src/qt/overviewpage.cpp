...
// Copyright (c) 2018-2019 The MasterCoreCoin developers
...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::MAC)
    {
    }
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount macAvailableBalance = balance - immatureBalance - nLockedBalance;

    // MAC Watch-Only Balance
    CAmount nTotalWatchBalance = watchOnlyBalance + watchUnconfBalance;
    CAmount nAvailableWatchBalance = watchOnlyBalance - watchImmatureBalance - nWatchOnlyLockedBalance;

    // MAC labels
    ui->labelBalance->setText(BitcoinUnits::floorHtmlWithUnit(nDisplayUnit, macAvailableBalance, false, BitcoinUnits::separatorAlways));
    ...
    // MAC Available
    bool showMACAvailable = settingShowAllBalances || macAvailableBalance != nTotalBalance;
    bool showWatchOnlyMACAvailable = showMACAvailable || nAvailableWatchBalance != nTotalWatchBalance;
    ui->labelBalanceText->setVisible(showMACAvailable || showWatchOnlyMACAvailable);
    ui->labelBalance->setVisible(showMACAvailable || showWatchOnlyMACAvailable);
    ui->labelWatchAvailable->setVisible(showMACAvailable && showWatchOnly);

    // MAC Pending
    bool showMACPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyMACPending = showMACPending || watchUnconfBalance != 0;
    ui->labelPendingText->setVisible(showMACPending || showWatchOnlyMACPending);
    ui->labelUnconfirmed->setVisible(showMACPending || showWatchOnlyMACPending);
    ui->labelWatchPending->setVisible(showMACPending && showWatchOnly);
    ...
    // MAC Locked
    bool showMACLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyMACLocked = showMACLocked || nWatchOnlyLockedBalance != 0;
    ui->labelLockedBalanceText->setVisible(showMACLocked || showWatchOnlyMACLocked);
    ui->labelLockedBalance->setVisible(showMACLocked || showWatchOnlyMACLocked);
    ui->labelWatchLocked->setVisible(showMACLocked && showWatchOnly);
...
void OverviewPage::SetLinks()
{
    ...
    ui->labelLinksUrl1->setText("<a href=\"https://www.mastercorecoin.org/\">https://www.mastercorecoin.org/</a>");
    ui->labelLinksUrl2->setText("<a href=\"https://www.mastercorecoin.org/whitepaper\">https://www.mastercorecoin.org/whitepaper</a>");
    ui->labelLinksUrl3->setText("<a href=\"https://explorer.mastercorecoin.org/\">https://explorer.mastercorecoin.org/</a>");
    ui->labelLinksUrl4->setText("<a href=\"https://twitter.com/mastercorecoin\">https://twitter.com/mastercorecoin</a>");
    ui->labelLinksUrl5->setText("<a href=\"https://github.com/MasterCoreCoin/mastercorecoin\">https://github.com/MasterCoreCoin/mastercorecoin</a>");
