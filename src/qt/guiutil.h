...
/** Utility functions used by the MasterCoreCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MAC addresses in monospace font
...
// Parse "mastercorecoin:" URI into recipient object, return true on successful parsing
