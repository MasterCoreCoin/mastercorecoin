...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MAC:
            return QString("tMAC");
        case mMAC:
            return QString("mtMAC");
        case uMAC:
            return QString::fromUtf8("μtMAC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case MAC:
            return QString("MAC");
        case mMAC:
            return QString("Milli-MAC (1 / 1" THIN_SP_UTF8 "000)");
        case uMAC:
            return QString("Micro-MAC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case MAC:
            return QString("TestMACs");
        case mMAC:
            return QString("Milli-TestMAC (1 / 1" THIN_SP_UTF8 "000)");
        case uMAC:
            return QString("Micro-TestMAC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
