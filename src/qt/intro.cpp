...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterCoreCoin Core"),
     ...
     * override -datadir in the mastercorecoin.conf file in the default data directory
     * (to be consistent with mastercorecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
