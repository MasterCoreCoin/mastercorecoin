...
// Repair parameters
const QString MASTERCORECOINWALLET("-mastercorecoinwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_mastercorecoinwallet, SIGNAL(clicked()), this, SLOT(walletMasterCoreCoin()));
...
/** Restart wallet with "-mastercorecoinwallet" */
void RPCConsole::walletMasterCoreCoin()
{
    buildParameterlist(MASTERCORECOINWALLET);
}
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    args.removeAll(MASTERCORECOINWALLET);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MasterCoreCoin RPC console.") + "<br>" +
