...
int nStakeTargetSpacing = 60; // MasterCoreCoin: 1 minute blocks during POS (block 201+)
...
{
    // MasterCoreCoin will hash in the transaction hash and the index number in order to make sure each hash is unique
